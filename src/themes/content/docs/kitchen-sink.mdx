...
<Card title="Card title">The content of the card that can use any other Markdown syntax.</Card>
...
<LinkCard title="Link title" description="The description of the link." href="#_" />
